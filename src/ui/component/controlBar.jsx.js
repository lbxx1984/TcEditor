define(function (require) {
    ...
    return React.createClass({
        ...
        buttonClickHandler: function (event) {
            ...
            if (dom.className.indexOf('disable') > -1) return;
            switch (dataset.uiType) {
                case 'checkbox':
                    ...
                    this.props.clickHandler(dataset.uiCmd, value);
                    break;
                case 'button':
                    this.props.clickHandler(dataset.uiCmd);
                    break;
                case 'radio':
                    var state = {};
        ...
        render: function () {
            var me = this;
            return (<div className="control-bar">{this.props.datasource.map(prepare)}</div>);
